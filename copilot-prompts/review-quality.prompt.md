---
name: 'review-quality'
description: 'Code quality review: naming, structure, duplication, complexity, conventions'
---
...
Read any AGENTS.md, CLAUDE.md, or CLAUDE.local.md in the repo for project-specific conventions.
...
Save report to `docs/reviews/[DATE]_[description]-quality.md`:
