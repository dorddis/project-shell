...
```
- Current user dominant (>50% of commits) → AUTHORED.
- Otherwise → NON-AUTHORED.
- User can override ("this is a vendor PR I picked up" / "this is my PR").
...
- **Auto-posting replies to GitHub or Slack** — drafts go in the report; main-agent posts after the user reviews.
